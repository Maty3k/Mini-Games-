...
| Game | What it is |
|------|------------|
| **GRAND PRIX** | 3D racer on **6 real circuits** (Melbourne, Monza, Silverstone, Suzuka, Spa, Monaco — real survey data, accurate lengths & racing direction, terrain that follows the real elevation incl. Suzuka's crossover bridge). GLTF Ferrari + **downloaded PBR road/grass textures**, HDRI sky + reflections, soft shadows, bloom; a **car garage** (Ferrari GT, a sculpted F1 single-seater, CC0 kit cars; 6 paint colours); **drivable pit lanes** with 10 named team garages and an **animated pit stop** (tyre wear, jacks, crew, 3-second service) at your own yellow box; **tyre compounds** (soft/medium/hard/wets — grip vs. wear, pick the next set with keys 1-4) and **weather** (dry, rain with particles/spray/wet reflective asphalt/no DRS, or mixed with rain arriving mid-race); **11 persistent missions** (wins, hot laps, pit stops, overtakes, a wet win…); Monaco is a true **street circuit** — walls at the track edge, the tunnel, and the harbour with moored yachts; **1–7 named AI rivals**, selectable **track / laps / difficulty / FOV / camera**, a 3-2-1 start, live **standings with gap/interval timing**, **DRS zones** (for you *and* the AI), an **RPM + gear gauge**, and a finish screen. |
